<div class="row">
	<section class="privay_policy_wrap">
		<div class="container">
			...
			<p>These terms and conditions outline the rules and regulations for the use of couponzipcode's Website.<br>
				couponzipcode is located at:<br>
				<strong>flushing, ny 11367</strong><br>
				<strong>United States</strong>
			</p>
			<p>By accessing this website we assume you accept these terms and conditions in full. Do not continue to use couponzipcode's website if you do not accept all of the terms and conditions stated on this page. </p>
			...
			<h4>License</h4>
			<p>Unless otherwise stated, couponzipcode and/or it’s licensors own the intellectual property rights for all material on couponzipcode All intellectual property rights are reserved. You may view and/or print pages from http://couponzipcode.com for your own personal use subject to restrictions set in these terms and conditions.</p>
			<p>You must not:</p>
			<ul>
				<li>Republish material from <a href="http://couponzipcode.com">http://couponzipcode.com</a></li>
				<li>Sell, rent or sub-license material from  <a href="http://couponzipcode.com">http://couponzipcode.com</a></li>
				<li>Reproduce, duplicate or copy material from  <a href="http://couponzipcode.com">http://couponzipcode.com</a></li>
