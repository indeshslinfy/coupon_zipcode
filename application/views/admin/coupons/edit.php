                    ...
                    <form class="mt-20" action="<?php echo base_url(ADMIN_PREFIX . '/save-coupon') . '/' . $coupon_details['id']; ?>" method="POST" enctype="multipart/form-data">
						<div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control coupon_zipcode" id="coupon_zipcode" pattern="^(?!\s*$).+" required="" value="<?php echo get_zipcode_name($coupon_details['coupon_zipcode_id']); ?>">
						...
						<div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="coupon_title" value="<?php echo $coupon_details['coupon_title']; ?>" class="form-control" pattern="^(?!\s*$).+" required="">
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="coupon_start_date" value="<?php echo date("d-m-Y", strtotime($coupon_details['coupon_start_date'])); ?>" class="form-control datepicker">
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="coupon_end_date" value="<?php echo date("d-m-Y", strtotime($coupon_details['coupon_end_date'])); ?>" class="form-control datepicker">
                            </div>
                        </div>
