...
{
    function iplugin($folder, $file)
    {
        $plugin_url = plugin_url() . $folder . "/";
        if ($file['file_type'] == 'css')
        {
            return '<link rel="stylesheet" type="text/css" href="' . $plugin_url . $file['file_name'] . '.css" media="all">'."\n";
        }
        elseif ($file['file_type'] == 'js')
        {
            return '<script type="text/javascript" src="' . $plugin_url . $file['file_name'] . '.js"></script>'."\n";
        }
    }
}
